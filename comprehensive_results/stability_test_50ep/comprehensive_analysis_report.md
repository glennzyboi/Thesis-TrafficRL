...
**Analysis Date**: 2025-10-17 21:18:28
...
- **Best Reward**: -260.42
- **Learning Improvement**: -9.2%
- **Convergence**: Episode 28

## Performance vs Baseline

- **Waiting Time**: +35.7% PASS
- **Speed**: +6.8% PASS
- **Queue Length**: +7.2% PASS
- **Completed Trips**: +15.1% PASS
- **Throughput**: +15.1% PASS

## Research Comparison

Our results compared to established traffic RL studies:

**Waiting Time Improvement**: 35.7%
