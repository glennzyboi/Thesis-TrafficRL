...
**Analysis Date**: 2025-10-16 16:26:27
...
- **Waiting Time**: +35.1% PASS
- **Speed**: +6.0% PASS
- **Queue Length**: +6.2% PASS
- **Completed Trips**: +15.0% PASS
- **Throughput**: +15.0% PASS

## Research Comparison

Our results compared to established traffic RL studies:

**Waiting Time Improvement**: 35.1%
